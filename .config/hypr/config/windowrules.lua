...
hl.window_rule({ match = { class = "^([Cc]ode)$"                           }, opacity = "0.80 override 0.80 override 1.0 override" })
hl.window_rule({ match = { class = "^(code-url-handler)$"                  }, opacity = "0.80 override 0.80 override 1.0 override" })
hl.window_rule({ match = { class = "^(code-insiders-url-handler)$"         }, opacity = "0.80 override 0.80 override 1.0 override" })
hl.window_rule({ match = { class = "^(nwg-look)$"                          }, opacity = "0.80 override 0.80 override 1.0 override" })
hl.window_rule({ match = { class = "^(qalculate-gtk)$"                     }, opacity = "0.80 override 0.80 override 1.0 override" })
hl.window_rule({ match = { class = "^(qt5ct)$"                             }, opacity = "0.80 override 0.80 override 1.0 override" })
hl.window_rule({ match = { class = "^(qt6ct)$"                             }, opacity = "0.80 override 0.80 override 1.0 override" })
hl.window_rule({ match = { class = "^(kvantummanager)$"                    }, opacity = "0.80 override 0.80 override 1.0 override" })

-- Opacity — system utilities (more transparent when inactive)
hl.window_rule({ match = { class = "^(org.pulseaudio.pavucontrol)$"                           }, opacity = "0.80 override 0.70 override 1.0 override" })
hl.window_rule({ match = { class = "^(blueman-manager)$"                                      }, opacity = "0.80 override 0.70 override 1.0 override" })
hl.window_rule({ match = { class = "^(nm-applet)$"                                            }, opacity = "0.80 override 0.70 override 1.0 override" })
hl.window_rule({ match = { class = "^(nm-connection-editor)$"                                 }, opacity = "0.80 override 0.70 override 1.0 override" })
hl.window_rule({ match = { class = "^(org.kde.polkit-kde-authentication-agent-1)$"            }, opacity = "0.80 override 0.70 override 1.0 override" })
hl.window_rule({ match = { class = "^(polkit-gnome-authentication-agent-1)$"                  }, opacity = "0.80 override 0.70 override 1.0 override" })
hl.window_rule({ match = { class = "^(org.freedesktop.impl.portal.desktop.gtk)$"             }, opacity = "0.80 override 0.70 override 1.0 override" })
hl.window_rule({ match = { class = "^(org.freedesktop.impl.portal.desktop.hyprland)$"        }, opacity = "0.80 override 0.70 override 1.0 override" })
hl.window_rule({ match = { class = "^([Ss]team)$"                                             }, opacity = "0.70 override 0.70 override 1.0 override" })
hl.window_rule({ match = { class = "^(steamwebhelper)$"                                       }, opacity = "0.70 override 0.70 override 1.0 override" })
